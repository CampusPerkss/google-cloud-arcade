...
echo "${CYAN_TEXT}${BOLD_TEXT}              Welcome to CampusPerks Cloud Labs          ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}╚════════════════════════════════════════════════════════╝${RESET_FORMAT}"
echo
...
echo "${GREEN_TEXT}${BOLD_TEXT} ========================== Transferring script to 'gcelab' instance ========================== ${RESET_FORMAT}"
echo

gcloud compute scp prepare_disk.sh gcelab:/tmp --project=$DEVSHELL_PROJECT_ID --zone=$ZONE --quiet

echo "${GREEN_TEXT}${BOLD_TEXT} ========================== Executing script on 'gcelab' ========================== ${RESET_FORMAT}"
echo
...
echo -e "${RED_TEXT}${BOLD_TEXT}Subscribe to CampusPerks:${RESET_FORMAT} ${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@CampusPerkss${RESET_FORMAT}"
