...
echo "${RANDOM_BG_COLOR}${RANDOM_TEXT_COLOR}${BOLD}Welcome to CampusPerks | Google Cloud Arcade${RESET}"
...
echo "${BOLD}${CYAN}Thanks for learning with CampusPerks 🚀${RESET}"
echo "${BOLD}${CYAN}YouTube: https://www.youtube.com/@CampusPerkss${RESET}"
